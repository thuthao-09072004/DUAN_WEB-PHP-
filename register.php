  ...
  <?php
    ...
    <div class="container">
      <form action="" method="post">
         <h3 style="color:white">Đăng ký để sử dụng <a href="index.php"><span>THU THAO  </span><span>STORE</span></a></h3>
         ...
         <p>Bạn đã có tài khoản? <br> <a class="link" href="login.php">Login</a><a class="link" href="index.php">QUAY LẠI</a></p>
      </form>
    </div>
