...
<html lang="en">
  <head>
    ...
    <title>THUTHAO STORE Admin</title>
  </head>
  ...
  <body >
    ...
    <div class="main_box">
      ...
      <?php
        ...
        <!-- <div class="card-body">
          <h5 class="card-title">Số lượng đơn hàng đang chờ xử lý </h5>
          <p class="card-text"> 
      ...
      <div class="card" style="width: 15rem">
        ...
        <div class="card-body">
          ...
          <a href="admin_orders.php" class="btn btn-primary">CHITIET</a>
        </div>
      </div>
      <div class="card" style="width: 15rem">
      ...
      <div class="card" style="width: 15rem">
        ...
        <div class="card-body">
          ...
          <a href="message_admin.php" class="btn btn-primary">CHITIET</a>
        </div>
      </div>
      <div class="card" style="width: 15rem">
        ...
        <div class="card-body">
          ...
          <a href="users_detail.php" class="btn btn-primary">CHITIET</a>
        </div>
      </div>
      <div class="card" style="width: 15rem">
