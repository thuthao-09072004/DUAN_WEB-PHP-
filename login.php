...
if(isset($message)){
    ...
    <div class="container">
        <form action="" method="post">
            <h3 style="color:white">login to <a href="index.php"><span>THUTHAO </span><span>STORE</span></a></h3>
            ...
            <p>Bạn chưa có tài khoản? <br> <a class="link" href="Register.php">Đăng ký</a><a class="link" href="index.php">Back</a></p>
        </form>
    </div>
