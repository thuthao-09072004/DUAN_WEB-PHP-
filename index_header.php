...
<body>
  <header>
    <div class="logo">
        <a href="index.php"><span>THU THAO</span>
    ...
    <div class="nav">
        ...
        <div class="dropdown">
            ...
            <a href="index.php#New">MỚi đến</a>
                <a href="index.php#Adventure">Cuộc phiêu lưu</a>
                <a href="index.php#Magical">Cuốn Sách hay</a>
                <a href="index.php#Knowledge">kiến thức bổ ích</a>

            </div>
        </div>
        <a href="contact-us.php">góp ý</a>
