...
if(isset($_POST['update'])){
    ...
    $message[]=''.$user_name.'  Giỏ hàng của bạn đã được cập nhật thành công';
}
...
<body>
    ...
    ?>
        ...
        <a href="checkout.php" class="btn cart-btn1" style="display:<?php if($total>1){ echo 'inline-block'; }else{ echo 'none'; };?>" > &nbsp; Tiến hành kiểm tra</a> <a class="cart-btn2" href="index.php">Tiếp tục mua </a>
    </div>
